...
$qs = [];
$qs['region'] = $region;
if (!empty($partner_date)) $qs['partner_date'] = $partner_date;
...
$st_count->bind_param('s', $partner_date);
$st_count->execute();
$res_cnt = $st_count->get_result()->fetch_assoc();
$st_count->close();

$total_count = (int)($res_cnt['cnt'] ?? 0);
$total_pages = max(1, (int)ceil($total_count / $per_page));
if ($page > $total_pages) $page = $total_pages;
$offset = ($page - 1) * $per_page;

// ✅ 선택 날짜의 dividend 데이터를 "Row mode"로 조회
