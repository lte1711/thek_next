    <h2 style="text-align:center;"><?= t('title.list.master', 'Master Member List') ?></h2>
    ...
    <table id="memberTable">
        ...
        <?php if ($result && mysqli_num_rows($result) > 0): ?>
                ...
                <tr>
                    ...
                    <td data-label="<?= t('table.manage', 'Manage') ?>">
                        <div class="button-group">
                            <a class="button edit"
                               href="edit_member.php?id=<?= $row['id'] ?>&redirect=master_list.php">
                               ✏ <?= t('btn.edit', 'Edit') ?>
                            </a>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <tr><td colspan="6"><?= t('msg.no_master_members', 'No master members found.') ?></td></tr>
        <?php endif; ?>
    </table>
</section>
