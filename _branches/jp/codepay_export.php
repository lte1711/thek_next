...
if ($_SESSION['role'] !== 'gm') {
    $__msg = t('common.no_permission', 'You do not have permission.');
    echo "<script>alert(" .  json_encode($__msg) . "); window.location.href='gm_dashboard.php';</script>";
    exit;
}
...
$page_title   = t('title.codepay_export','CodePay Export');
