...
";
    ...
    echo t('error.db_error_prefix','DB error:') . " " . htmlspecialchars($e->getMessage());
    exit;
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <table>
        <tr>
            <th><?= t('report.year','년도') ?></th><th><?= t('report.month','월') ?></th>
            <th><?= t('report.investor','Investor') ?></th><th><?= t('report.malaysia','Malaysia') ?></th><th><?= t('report.thek','Thek') ?></th><th><?= t('report.vietnam','Vietnam') ?></th>
            <th><?= t('report.admin','Admin') ?></th><th><?= t('report.master','Master') ?></th><th><?= t('report.agent','Agent') ?></th><th><?= t('report.referrer','Referrer') ?></th>
        </tr>
    ...
    <table>
        <tr><th><?= t('report.year','년도') ?></th><th><?= t('report.month','월') ?></th><th><?= t('report.avg_sales_pct','평균 Sales %') ?></th></tr>
