...
<div class="card">
  <h2 style="margin-top:0;">관리자 입금 등록</h2>
  <form method="POST">
    <?= csrf_input() ?>
...
<div class="card">
  <div style="display:flex; align-items:center; justify-content:space-between; gap:10px; flex-wrap:wrap;">
    <h2 style="margin:0;">관리자 입금 목록</h2>
      ...
      <table>
        ...
        ?>
          <tr>
            ...
            <td><input form="<?= $f_upd ?>" type="date" name="deposit_date" value="<?= htmlspecialchars($row['deposit_date']) ?>"></td>
